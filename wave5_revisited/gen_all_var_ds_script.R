# generate a new nonnegtive dataset containing all of the democratic variables
...
country_code = readxl::read_xlsx("/Users/zhaoyikai/Comparative_pol_measurement_project/country_code_5.xlsx", col_names = F)
...
demo_vars = c("country", paste("V", 152:161, sep = "")) 
...
colnames(nonnegtive) = c("country", "tax", "religion", "free_election", "state_aid",
                         "Army", "civil_rights", 'prospering', 'criminals', 'referendums',
                         "women")

# write out csv file
write.csv(nonnegtive, "nonnegative_wv5_allvars.csv", row.names = FALSE)
