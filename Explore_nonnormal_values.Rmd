...
In sum, the main issue we need to deal with are those -2 and -1's. Should we just simply impute them to a midpoint or we want to impute them based on other variables...
...
rmarkdown::render("markdown2.Rmd")
